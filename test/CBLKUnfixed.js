...
describe('CBLKUnfixed', () => {
  ...
  beforeEach(async () => {
    ...
    await CBT1.approve(CBLKUnfixed.address, ethers.utils.parseEther('1000'));
    await CBT2.mint(deployer.address, ethers.utils.parseEther('1000'));
    await CBT2.approve(CBLKUnfixed.address, ethers.utils.parseEther('1000'));
    await CBT3.mint(deployer.address, ethers.utils.parseEther('1000'));
    await CBT3.approve(CBLKUnfixed.address, ethers.utils.parseEther('1000'));
  ...
  describe('Rebalance', async () => {
    ...
    it('Emits `Rebalance` event ', async () => {
      await CBT2.mint(deployer.address, ethers.utils.parseEther('250'));
      await CBT2.approve(CBLKUnfixed.address, ethers.utils.parseEther('250'));
      await expect(
    ...
    it('Rebalance with equal input and output', async () => {
      await CBT2.mint(deployer.address, ethers.utils.parseEther('100'));
      await CBT2.approve(CBLKUnfixed.address, ethers.utils.parseEther('100'));
      await CBLKUnfixed.rebalance(
        [CBT2.address],
    ...
    it('Mints CBLKUnfixed when input > output', async () => {
      await CBT2.mint(deployer.address, ethers.utils.parseEther('500'));
      await CBT2.approve(CBLKUnfixed.address, ethers.utils.parseEther('500'));
      await CBLKUnfixed.rebalance(
        [CBT2.address],
    ...
    it('Introduction of new token', async () => {
      ...
      await CBT4.mint(deployer.address, ethers.utils.parseEther('1000'));
      await CBT4.approve(CBLKUnfixed.address, ethers.utils.parseEther('1000'));
